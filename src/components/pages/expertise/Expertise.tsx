...
export default function Expertise({}: Props) {
	return (
		<section
			...
			id="expertise"
		>
			<Container className="lg:pt-[160px] sm:pt-[80px] pt-15 xl:pb-[236px] lg:pb-[216px] sm:pb-[124px] pb-[104px] xl:px-[120px] lg:px-[100px] sm:px-[28px] px-5 flex lg:flex-row flex-col justify-between">
				<div className="flex-col">
					<ScrollAnimation>
						<SubHeader text={'expertise'}></SubHeader>
					</ScrollAnimation>
					<ScrollAnimation className="sm:flex sm:justify-center lg:block">
						<div className="lg:w-[280px] sm:w-[350px] w-full lg:h-[360px] md:h-[320px] lg:mt-12 sm:mt-[-18px] mt-5">
							<video
								height={'100%'}
								width={'100%'}
								controls={false}
				...
				<div className="lg:w-[67%] w-full flex-col justify-center mt-10 sm:mt-40 lg:mt-0">
					...
					<ScrollAnimation>
						<div className="xl:text-xl lg:text-[18px] sm:text-[20px] text-[18px] font-normal opacity-80 lg:mt-[86px] mt-[60px] lg:w-[53%] sm:w-[70%] w-full justify-self-start sm:ml-[26%]">
