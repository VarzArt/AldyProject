...
export default function MainPage({}: Props) {
	...
	return (
		<section className=" font-[Satoshi] flex justify-center">
			<Container className="flex flex-col items-center xl:pt-[60px] pt-10 xl:pb-[180px] lg:pb-[160px] sm:pb-[120px] pb-[80px] xl:px-[120px] lg:px-[100px] sm:px-[80] px-5">
				...
				<div className="flex items-center justify-between w-full">
					...
					<Heading
						text={`digital design \n studio`}
						className="uppercase xl:text-[112px] lg:text-[98px] sm:text-[78px] text-[40px] w-full font-black leading-[100%] tracking-[-2%] max-w-[1168px] text-center whitespace-pre-line"
					></Heading>
				...
				<div className=" border-t border-t-gray-300/10 border-b border-b-gray-300/10 xl:py-15 py-8 w-full flex justify-center">
					<div className="max-w-[1680] w-[100%] h-max">
						...
						<video
							...
							muted
							disablePictureInPicture
							className="rounded-xl block sm:hidden"
						>
					...
					<div className="sm:w-[50%] w-full">
						<ScrollAnimation>
							<Heading
								...
								className="uppercase font-extrabold lg:text-[54px] xl:text-[64px] sm:text-[42px] text-4xl lg:w-[510px] w-[360px] leading-[110%] xl:mt-15 sm:mt-12 mt-0"
							></Heading>
						</ScrollAnimation>
					</div>
				...
				<div className="xl:pt-[140px] sm:pt-[100px] pt-20 flex justify-between items-center w-full font-[Satoshi] sm:flex-row flex-col sm:gap-0 gap-2">
					{infoCardsConstants.map((infoCard, index) => (
						<div key={infoCard.id} className="sm:w-[32.8%] w-full">
